...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211017_flowerballoons_17153321cfee67708283_20211017171256_archive.zip';
    const ARCHIVE_SIZE       = '83441295';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '1715332-17171256';
    const SECONDARY_PACKAGE_HASH = '2ef834a-17171256';
    const VERSION            = '4.0.3';
...
//]]></script>
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.3==');
        $this->log('----------------------------------------------------');
